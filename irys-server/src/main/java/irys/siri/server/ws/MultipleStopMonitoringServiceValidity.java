 ...
 * @author marc
 */
public class MultipleStopMonitoringServiceValidity {
    private AbstractSiriServiceDelegate siriService;
    private GetMultipleStopMonitoringDocument requestDoc;
    
    private Boolean isSchemaCompliant = null;
    private Boolean isServiceCompliant = null;
    
    public MultipleStopMonitoringServiceValidity(AbstractSiriServiceDelegate siriService, GetMultipleStopMonitoringDocument requestDoc2) 
    {
        this.siriService = siriService;
        this.requestDoc = requestDoc2;
    }
   ...
   public boolean isSchemaCompliantRequest()
   {
       if ( isSchemaCompliant!=null)
        ...
        if (siriService.requestValidation) {
            ...
            if (requestDoc.getGetMultipleStopMonitoring() != null)
            {
            ...
            isSchemaCompliant = (requestDoc.getGetMultipleStopMonitoring() != null) && infoOk && requestOk;
        }
